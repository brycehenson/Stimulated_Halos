function[three_channel_output_combined_sorted]= dld_read_5channels_reconst_multi(filename_call,normalise_time_flag_call,reconst_4_corners_nomcp_flag_call,reconst_3_corners_flag_call)
...
[noth, NewRowNumber] = sort(dld_output_raw(:,2));
    ...
    if check1 < max_group_time
        ...
        if check2 > max_group_time
            ...
            if check3 > check1 + dead_time  %was max_group_time instead of check1, but now this checks based on spread of events in group
                ...
                [rubbish_var1, NewRowNum_gm1] = sort(group_matrix_1(:,1));
...
[noth, NewRowNumber3chan] = sort(three_channel_output_combined(:,1));
