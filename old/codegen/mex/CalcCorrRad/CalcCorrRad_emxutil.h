/*
 * CalcCorrRad_emxutil.h
 *
 * Code generation for function 'CalcCorrRad_emxutil'
 *
 */

#ifndef CALCCORRRAD_EMXUTIL_H
#define CALCCORRRAD_EMXUTIL_H
...
/* End of code generation (CalcCorrRad_emxutil.h) */
