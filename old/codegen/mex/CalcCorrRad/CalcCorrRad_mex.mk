START_DIR = C:\Users\Bryce\Dropbox\UNI\project\programs\HALOCO~1

MATLAB_ROOT = C:\PROGRA~1\MATLAB\R2016a
MAKEFILE = CalcCorrRad_mex.mk

include CalcCorrRad_mex.mki
...
SRC_FILES =  \
	...
	CalcCorrRad_emxutil.c

MEX_FILE_NAME_WO_EXT = CalcCorrRad_mex
...
SYS_INCLUDE += -I"$(START_DIR)\codegen\mex\CalcCorrRad"
...
%.$(OBJEXT) : $(START_DIR)\codegen\mex\CalcCorrRad/%.c
	$(CC) -Fo"$@" $(CFLAGS) "$<"
